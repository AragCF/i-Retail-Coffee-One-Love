...
public class TerminalData extends BaseBundleParcelable {
    ...
    protected TerminalData(Parcel in) {
        super(in, TerminalData.class.getClassLoader());
        bundle.setClassLoader(TerminalData.class.getClassLoader());
    }
    ...
    public static final Parcelable.Creator<TerminalData> CREATOR = new Parcelable.Creator<TerminalData>() {
        @Override public TerminalData createFromParcel(Parcel in) { return new TerminalData(in); }
        @Override public TerminalData[] newArray(int size) { return new TerminalData[size]; }
    };
}
