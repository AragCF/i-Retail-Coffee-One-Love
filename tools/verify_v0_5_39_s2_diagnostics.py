...
checks = {
    "versionCode 39": "versionCode 39" in build,
    "versionName 0.5.39": "versionName '0.5.39-s2-catalog-diagnostics'" in build,
...
if failed:
    raise SystemExit("v0.5.39 S2 diagnostics guard failed: " + ", ".join(failed))

print(f"[OK] v0.5.39 S2 diagnostics guard: {len(checks)} checks passed")
