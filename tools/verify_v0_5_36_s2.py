...
checks = {
    "versionCode 36": "versionCode 36" in build,
    "versionName 0.5.36": "versionName '0.5.36-s2-catalog-money'" in build,
...
print(f"[OK] v0.5.36 S2 guard: {len(checks)} checks passed")
