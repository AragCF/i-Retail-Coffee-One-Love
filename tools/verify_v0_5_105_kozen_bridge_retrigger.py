...
checks = {
    ...
    "Kozen bridge retrigger exists": 'com.coffeeonelove.iretail.kozenbridge/.BridgeActivity' in main26,
    "retrigger occurs during preflight": main26.find('com.coffeeonelove.iretail.kozenbridge/.BridgeActivity') < main26.find('findstr /C:"TEST_PREFLIGHT_FAILED"'),
