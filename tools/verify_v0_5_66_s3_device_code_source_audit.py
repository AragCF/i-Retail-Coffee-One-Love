...
checks = {
    "versionCode at least 66": bool(m) and int(m.group(1)) >= 66,
    ...
    "run branch": "v0.5.66-s3-device-code-source-audit" in run,
    "publish branch": "v0.5.66-s3-device-code-source-audit" in pub,
