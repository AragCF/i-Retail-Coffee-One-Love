...
checks = {
    "versionCode 49": "versionCode 49" in build,
    "versionName 0.5.49": "versionName '0.5.49-s3-order-dependency-audit'" in build,
...
if failed:
    raise SystemExit("v0.5.49 S3 dependency audit guard failed: " + ", ".join(failed))

print(f"[OK] v0.5.49 S3 dependency audit guard: {len(checks)} checks passed")
