...
checks = {
    "versionCode 48": "versionCode 48" in build,
    "versionName 0.5.47": "versionName '0.5.48-s3-order-contract-audit-fix'" in build,
...
if failed:
    raise SystemExit("v0.5.48 S3 order contract audit guard failed: " + ", ".join(failed))

print(f"[OK] v0.5.48 S3 order contract audit guard: {len(checks)} checks passed")
