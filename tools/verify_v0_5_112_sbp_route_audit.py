...
checks={
    ...
    "bridge version supports route audit": any(x in bridge for x in ['BRIDGE_VERSION = "0.5.3"','BRIDGE_VERSION = "0.5.4"','BRIDGE_VERSION = "0.5.5"','BRIDGE_VERSION = "0.5.6"','BRIDGE_VERSION = "0.5.7"']),
    ...
    "QR Binder probe remains locked": "LIVE_QR_GENERATION_PROBE_ENABLED = false" in bridge and '"QR_PAYMENT".equals(command)) return qrPaymentBlocked(id)' in bridge,
