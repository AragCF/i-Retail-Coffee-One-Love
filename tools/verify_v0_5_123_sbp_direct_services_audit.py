...
checks = {
    ...
    "audit never creates payment": 'iretail/payment-in/create' not in audit,
    "audit never reverts payment": 'iretail/payment-in/revert' not in audit,
    "audit has no Kozen/ADB dependency": all(x not in audit.lower() for x in ["adb ", "smartsky", "kozenaoa", "usb/aoa"]),
