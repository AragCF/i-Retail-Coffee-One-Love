...
checks={
    ...
    "versionName v0.5.114": "versionName '0.5.114-sbp-wire-sanitizer'" in gradle,
    "wire contract recorded": 'WIRE_BRIDGE_VERSION = "0.5.5"' in contract and 'WIRE_CONTRACT = "BASE64URL_REDACTED_V1"' in contract,
    "bridge version 0.5.5": 'BRIDGE_VERSION = "0.5.5"' in bridge,
    ...
    "client requires bridge 0.5.5": '!"0.5.5".equals(bridgeVersion)' in client,
    ...
    "main stores raw privately": "sbpSessionStore.save(record)" in main and "storedPrivately=true" in main,
