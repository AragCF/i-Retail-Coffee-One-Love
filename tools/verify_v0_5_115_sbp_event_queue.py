...
checks = {
    ...
    "bridge source version 0.5.6+": ('BRIDGE_VERSION = "0.5.6"' in bridge or 'BRIDGE_VERSION = "0.5.7"' in bridge),
    "bridge APK metadata 0.5.6+": (("versionCode 10" in bridge_gradle and "versionName '0.5.6-sbp-event-queue'" in bridge_gradle) or ("versionCode 11" in bridge_gradle and "versionName '0.5.7-sbp-qr-source-probe'" in bridge_gradle)),
