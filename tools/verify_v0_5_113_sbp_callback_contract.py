...
checks={
    ...
    "versionName v0.5.113": "versionName '0.5.113-sbp-callback-contract'" in gradle,
    "bridge version 0.5.4": 'BRIDGE_VERSION = "0.5.4"' in bridge,
    ...
    "SBP callback captures on slot 2": "SbpQrCapture.Event event = sbpQrCapture.capture(qrId, qrPayload)" in bridge,
    "SBP callback logs hashes only": all(x in bridge for x in ["SBP_CALLBACK_QR qrIdHash=","payloadHash=","payloadLength=","rawPayloadLogged=false"]),
