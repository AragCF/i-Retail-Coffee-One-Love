...
set "ZIP_NAME="
for /f "delims=" %%F in ('dir /b /a-d /o-d "usb_dual_logs\USB_DUAL_JL22_KOZEN_*.zip" 2^>nul') do if not defined ZIP_NAME set "ZIP_NAME=%%F"
...
set "LATEST_ZIP=%CD%\usb_dual_logs\%ZIP_NAME%"
